...
\begin{enumerate}
3
(i) X and Y are independent Poisson random variables with mean λ. Derive the moment generating function of X, and hence show that X + Y also has a Poisson distribution.
[4]
