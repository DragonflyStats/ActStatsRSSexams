...
Claim amounts on a portfolio of insurance policies are assumed to follow a Weibull
distribution. A quarter of losses are below 15 and a quarter of losses are above 80.
(ii) Estimate the parameters c, γ of the Weibull distribution that fit this data. [3]
...
(i) Calculate the Bayesian estimate of λ under all-or-nothing loss. [7]
