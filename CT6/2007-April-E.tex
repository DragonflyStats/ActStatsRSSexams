...
policyholders in the lower discount categories (or increase in the higher
discount categories)
(i) (a)
⎡ y α
⎤
...
For a continuous covariate, the value is included. For example, if x is a
continuous covariate, a main effect would be α + βx.
(iii)
(a)
...
α i + β j + γ i x
Page 11Subject CT6 (Statistical Methods Core Technical) — April 2007 — Examiners’ Report
