...
poachers also have three options: both try to escape through the farmyard (option \theta 1 );
one of them tries to escape from the farmyard and the other from the fields (option
\theta 2 ); both try to escape over the fields (option \theta 3 ). The number of birds they manage
...
3
(i) Show that \theta 1 does not dominate \theta 2 and vice versa.
...
(iii) Given the prior distribution P(\theta 1 ) = 0.25, P(\theta 2 ) = 0.35 and P(\theta 2 ) = 0.4,
...
(iii)
a 1 = 0.25 \times 0 + 0.35 \times 75 + 0.4 \times 120 = 74.25
a 2 = 0.25 \times 90 + 0.35 \times 0 + 0.4 \times 90 = 58.5
a 3 = 0.25 \times 120 + 0.35 \times 75 + 0.4 \times 0 = 56.25
