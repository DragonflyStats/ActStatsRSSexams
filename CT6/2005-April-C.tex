...
levels of discount: 0%, 25% and 50%.
...
remain at the maximum 50% level.
...
0.75 + 0.7182
0.5) = £467.59
(v) Intention is to automatically premium rate with NCD system. Small number of categories and the relatively low discount result in high proportion of
policyholders in maximum discount category. Many more categories and higher discount levels would be required to correctly rate such a
