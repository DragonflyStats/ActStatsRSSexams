...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%55
Claims on a certain portfolio of insurance policies arise as a Poisson process with annual rate . Individual claim amounts are independent from claim to claim and follow an exponential distribution with mean . The insurance company has
...
(b)
\begin{itemize}
\item The reinsurers annual rate of premium income is given by ( 1 + )
E(X i ). 
\item So the adjustment coefficient satisfies
 + (1 + ) E(X i )R =  M X i ( R )
i.e.
(iv)
1 + (1 + ) E(X i )R = M X i ( R )
...
%Full credit was given for alternative solutions to part (i) and part (iv). This question was relatively poorly answered, although those candidates who were able to make a good attempt tended to score well.
\end{document}
