...
6
3
L = D \times ∏ 3 cx i 2 e − cx i \times e − 4 \times 50
3
c
i = 1
...
6
6
l = log L = log D + ∑ log 3 cx i − c ∑ x i 3 − 4 \times 50 3 c
2
i = 1
i = 1
6 6
i = 1 i = 1
= log D + 6 log 3 + 6 log c + ∑ log x i 2 − c ∑ x i 3 − 4 \times 50 3 c
...
Now if there are n policies in the portfolio, total claim amounts S will have an approximately Normal distribution with mean 0.2 \times n \times 109 = 21.8 n and variance 0.2 \times n \times 148.56 2 .
...
Most candidates struggled with this question. Many did not calculate the variance correctly and a lot did not correctly use the number of policies, n, as a multiplier for the mean and variance of the claims. Others used n and the claim rate when calculating the additional
