...
\item  For k = 2 we have that
  \rho_{2} = 0.6\rho_1 + 0.16\rho0 = 0.16\rho_1 + 0.6 =
    0.62
  0.84 + 0.16
  = 0.5886 = 103/175. 
\item  For k = 3
  ...
  = 0.4674 = 409/875 
\item  For k = 4
  \rho4 = 0.6\rho_{3} + 0.16\rho_{2} = 0.6 * 0.4674286 + 0.16 * 0.5884714
  = 0.3746 = 1639/4375 
  For the partial autocorrelation function we have that
  \psi1 = \rho_1 = 0.7143 = 5/7 
\end{itemize}  
...
%  Page 10
  ...
  − \rho
  = 0.16 = 4/25 
  and \psi3 = \psi4 = 0 since Yt is AR(2). [½]
  [Total 7]
  [TOTAL 12]
