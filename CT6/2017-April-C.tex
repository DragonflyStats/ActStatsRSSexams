...
\begin{enumerate}
5 (i) Show that the following discrete distribution belongs to the exponential family
of distributions.
( ; ) n ny (1 )n ny 0, 1 , 2 , .,1
f y y
ny n n
...
 
[4]
(ii) Derive expressions for the mean and variance of the distribution, E(y) and
Var(y), using your answer to part (i). [4]
[Total 8]
...
parameters α and σ2, with reference to any relevant equations. [3]
