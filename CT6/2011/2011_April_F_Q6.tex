...
%% This question was poorly answered. Only the strongest candidates treated the modulus in the pdf correctly. There was also difficulty deriving both parts of the inverse function for both the u ≥ 0.5 and the u < 0.5 case.
