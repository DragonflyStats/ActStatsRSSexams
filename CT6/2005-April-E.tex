...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%55
9
Y 1 , Y 2 , , Y n are independent claims, which are assumed to be exponentially
distributed, with
E[Y i ] =
i
.
(i) Show that the canonical link function is the inverse link function.
(ii) It is decided that the canonical link function should not be used, but that the
...
20 i 1
24 i 21
Calculate the deviance residual for y 1 = 7.
CT6 A2005
5
[3]
[Total 18]
...
log y i
i 1
nSubject CT6 (Statistical Methods Core Technical)
April 2005
Examiners Report
