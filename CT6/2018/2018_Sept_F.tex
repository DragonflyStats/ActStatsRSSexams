...
\begin{enumerate}[(i)]
\item(i) Derive an expression for the estimator of β using the method of moments. [2]
\item (ii) Explain what the Maximum Likelihood Estimator (MLE) of β represents. [2]
\item (iii) Derive an expression for the MLE of β, commenting on the result.
\item (iv) State the Moment Generating Function (MGF) of X.[1]
\end{enumerate}
Let Y = 2n β X .
(v)

