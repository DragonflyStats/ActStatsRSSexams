...
Type II, which have claim amounts following an Exponential distribution with mean 3,600.
...
(ii) Calculate the minimum initial surplus Um required such that the probability of ruin at the end of the first year is less than 0.015, using a Normal approximation for the distribution of S. [4]
