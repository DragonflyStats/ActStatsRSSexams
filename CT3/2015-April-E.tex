...
Total 497.70 14
\begin{enumerate}[(i)]
\item  Test the hypothesis that there is no difference between team times against a general alternative. 
...
using your updated ANOVA table. 
(iv) Comment on the results of parts (i) and (iii). 
\end{enumerate}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
...
(ii) Clear outlier for team B, so not constant variance (also other valid comments about non-normality etc.)
...
F2,11;1% = 7.206
So H0 can be comfortably rejected at the 1\% level – and there does seem to be a difference between teams
