...
and E[X 3 ] = 60 3 .
\begin{enumerate}
\item \item (i) Determine the variance of this distribution and calculate the coefficient of skewness.
\item \item (ii) Let $\{X_1 , X 2 ,, X n\}$ be a random sample of n claim sizes for such claims. Show that the maximum likelihood estimator (MLE) of is given by
