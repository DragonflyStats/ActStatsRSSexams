...
S = X 1 + X 2 +
+ X N
where N is the number of claims and has a Poisson distribution with mean , X i is the amount of the i th claim, and the X i s are independent and identically distributed and
