...
\item %%-- Queation 10
Let $(X_1 , X_2 , \ldots , X_n )$ be a random sample of a gamma(4.5, ) random variable, with
sample mean X .
(i)
(ii)
2
...
(a)
(
L ( \lambda ) \propto \lambda 4.5 n exp −\lambda \sum x_i
)
so
...
(b) −
\item (c) 95\% CI is \hat{\lambda}\pm 1.96 × s . e . \lambda ˆ
d \lambda
2
{
\lambda ˆ
