...
as G 1 , G 2 , G 3 and G 4 . The number of policies included in each portfolio is given
below:
G 1
G 2
G 3
...
the four portfolios after one year and it is found that a claim did arise on this policy during the year. Calculate the probability that the selected policy comes from
portfolio G 3 .
