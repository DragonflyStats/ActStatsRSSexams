...
\item So do not reject H 0 at a 5\% significance level 
Now H 1 :  1   2 
Test statistic is the same, but now use t 36;0.95  1.688 
\item This time we reject H 0 
%%---- Page 9  – April 2017 – %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\item (vi)
The results of the tests in parts (iv) and (v) were different. The additional information allowed us to choose a more appropriate alternative hypothesis.

%%[Total 19]
\item The performance in this question was mixed. In parts \item (i) and \item (ii) many candidates failed to demonstrate that they can distinguish between a sample being random and being representative. A typical error in part ( iii) was the
