...
conclusions. 
\item (iv) Calculate 95% confidence intervals for the mean values of each of the three
...
There were no problems with the ANOVA part of this question. However, the explanation in part (i) was often unclear. In part (iv) some candidates failed to transform back to the
original scale.
\end{document}
