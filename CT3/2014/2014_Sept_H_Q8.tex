...
(v) There is a significant lower attendance with the higher price but, as the confidence interval contains zero, no significant difference in revenues.
Financially it doesn’t matter which price the promoter chooses, but the lower price would get more people to see the show. 

% Parts (i) – (iii) were well answered. In part (iv) some candidates did not realise that the required CI referred to revenue. In the same part, there were also many errors in calculating
% the common variance correctly. In part (v) other sensible comments were also given credit as appropriate.
\end{document}
