...
CT3 S2014–3 
%%-Question 5 
\item Consider two random variables X and Y with E[X] = 2, V[X] = 4, E[Y] = −3, V[Y] = 1,
and Cov[X, Y] = 1.6.
Calculate:
...
\end{verbatim}
\begin{enumerate}[(i)]
\item Explain why a standard two-sample t-test would not be appropriate in this
investigation to test the suggestion that daily exercise has the effect of
lowering blood pressure. 
\item Perform a suitable t-test for this medical study. You should clearly state the
