...
(b) Calculate a 95% confidence interval for μ A − μ C , using information
...
(b) Test the hypothesis H 0 : b 1 = 0 against H 1 : b 1 ≠ 0 at the 5% level of
significance.
...
Page 7Subject CT3 (Probability and Mathematical Statistics Core Technical) — September 2009 — Examiners’ Report
2
2
2
2
...
From yellow tables, F 2,12 (0.05) = 3.885 and F 2,12 (0.01) = 6.927. 1
...
(c)
0.5
We have y ˆ i 10.4 5.0 x i 1 7.6 x i 2 and for classical music
...
1
1
The 95% CI for A C in (i)(b) can be used for testing H 0:
