...
11
\begin{itemize}
\itiem (i) This is an F distribution with 10, 8 degrees of freedom.
\item (ii) ⎛ S 2 / S 2
S 2 / S 2 ⎞
...
11
9\]
\item Normality of the data then gives that Z =
\[\frac{X A − X B − ( \mu A −\mu B )}{ \sigma^2 \left[ \frac{1}{11} + \frac{1}{9} \right] } \sim  N (0,1)\]


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\item We are also given that Y =
\sigma
2
2
