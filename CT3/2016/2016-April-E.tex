...
\item (ii) Determine a 95% confidence interval for the expected value E[X] based on the
...
parameter .
(v) Determine a 95% confidence interval for  using a normal approximation. 
...
(iv) Theχ2 distribution is not symmetric. 
