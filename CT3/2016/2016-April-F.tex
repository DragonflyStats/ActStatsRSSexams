...
\item (i) (a) Determine the correlation coefficient between x and y.
...
parameter.
\item (ii) Determine the fitted line of the regression model. 
...
(iv) βˆ ×5 = −0.2345
Estimated difference in price will be \$234.34. 
[TOTAL 17]
Parts \item (i), \item (ii) and (iii) are typical questions on correlation and regression and
