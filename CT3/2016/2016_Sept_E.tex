...
x Subject CT3 (Probability and Mathematical Statistics Core Technical) – September 2016 – Examiners’ Report
Γ ′ ( α ˆ ) n
d
l ( α , λ ) = 0  n log λ ˆ − n
+ log ( x i ) = 0
...
The equation for α̂ cannot be solved analytically, so a numerical
