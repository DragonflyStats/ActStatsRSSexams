...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%-- Page 7
%%-- Subject CT3 (Probability and Mathematical Statistics Core Technical) — April 2009 — %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\item (i)
(a)
...
We reject the hypothesis H 0 : \beta = 0 in favour of H 1 : \beta > 0 at the 5\% level (but not at the 1% level).
(c)
...
or (58.636, 78.006)
\item (ii)
(d) The CI for the individual predicted score will be wider than the CI for the mean score in \item (i)(c), because the variance for the individual predicted value is larger.
