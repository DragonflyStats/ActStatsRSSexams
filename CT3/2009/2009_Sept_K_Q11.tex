...
\[s_B^2 \;=\; \frac{1}{10} \left( 8559 \;-\; \frac{(297)^2}{} \right)\;=\; 54.0 \]

%--------------------------------------%


\[ F \;=\; \frac{s_B^2}{s^2_A} \;=\; \frac{54.0}{15.8} \;=\; 3.418 on 10, 10 df 1\]

%--------------------------------------%
\item For a two-sided test at the 5\% level, critical value is
$F_{10,10(2.5\%)} = 3.717$
So we accept $H_0 :\sigma_B^2 \;=\; \sigma^2_A$ at the 5\% level.
1
$F_{10,10(2.5\%)} = 3.717$ and $F_{10,10(5\%)}   = 2.978$
...
2.528 2.086
1
\item Tests in (ii) and (iii) give different results at the 5\% level, but in fact have
