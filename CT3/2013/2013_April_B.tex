...
\begin{enumerate}
\item 
Consider a random sample, $\{ X_1 , \ldots, X_n\}$ , from a normal $N(\mu, \sigma^2 )$ distribution, with
sample mean X and sample variance $S^2$.
\begin{enumerate}[(i)]
\item Define carefully what it means to say that $\{ X_1 , \ldots, X_n\}$ is a random sample from
a normal distribution.

\item State what is known about the distributions of X and $S^2$ in this case,
