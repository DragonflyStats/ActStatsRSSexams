...
PLEASE TURN OVER6
A researcher obtains samples of 25 items from normally distributed measurements
...
between three groups of policyholders depending on the geographical region in which
they live. The probability p of a policyholder submitting at least one claim during a
year is given in the following table together with the number, n, of policyholders
belonging to each group.. Each policyholder belongs to exactly one group and it is
...
(i) Show that the probability that a randomly selected policyholder will submit a
claim in a particular year is 0.08.

(ii) Calculate the probability that a randomly selected policyholder will submit a
claim in a particular year given that the policyholder is not in group C.

(iii) Calculate the probability for a randomly selected policyholder to belong to
group A given that the policyholder submitted a claim last year.

(iv) Calculate the probability that a randomly selected policyholder will submit a
...
[3]
(v) Calculate the probability that a randomly selected policyholder will submit a
