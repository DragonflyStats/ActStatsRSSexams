...
( )
V ( Y i ) = E ( N i ) V X ij + V ( N i ) E ( X ij ) 2 = λσ 2 + λμ 2
(ii)
S also has a compound distribution.
E ( S ) = E ( M ) E ( Y i ) = κλμ
V ( S ) = E ( M ) V ( Y i ) + V ( M ) E ( Y i ) 2 = κλ ( σ 2 + μ 2 ) + κλ 2 μ 2 = κλ ( σ 2 + μ 2 + λμ 2 )
(iii)
P ( X ij ≤ x + C | X ij > C ) =
( 1 − e
=
...
V ( S R ) = κλ * ( σ 2 + μ 2 + λ * μ 2 ) = 4 × 135.3 × ( 1 + 1 + 135.3 ) = 74306.8
