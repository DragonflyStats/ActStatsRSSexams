...
graph.
(b) Use the graph produced in part (i)(a) to explain why the maximum likelihood estimate of θ is given by x ( n ) = max{ x 1 , x 2 , ... , x n } .
Let X ( n ) = max{ X 1 , X 2 , ... , X n } be the estimator of θ, that is the random variable corresponding to x ( n ) .
(ii)
(a)
