...
\item (ii) Calculate the exact probability that 0.2 \leq \hat{\lambda} \leq 0.3 if the sample size is n = 10.
...
\item 
(v) Calculate the minimal required sample size n for which the probability that 0.2 \leq \hat{\lambda} \leq 0.3 is at least 0.95, using the normal approximation without continuity correction
...
P [0.2 \leq \hat{\lambda} \leq 0.3] = P [2 \leq 10 \hat{\lambda} \leq 3] ≈ P [2 − 0.5 \leq 10 \hat{\lambda} \leq 3 + 0.5]
3.5 − 2.5 ⎤
⎡ 1.5 − 2.5
⎛ 1 ⎞
= P ⎢
...
3 − 2.5 ⎤
⎡ 2 − 2.5
P [0.2 \leq \hat{\lambda} \leq 0.3] = P [2 \leq 10 \hat{\lambda} \leq 3] ≈ P ⎢
\leq Z \leq
⎥
2.5 ⎦
⎣ 2.5
...
⎡ 0.2 − 0.25
⎛ 0.05 ⎞
P [0.2 \leq \hat{\lambda} \leq 0.3] ≈ P ⎢
\leq z \leq
⎟ − 1 = 0.95
⎥ = 2* F Z ⎜
0.25 / n ⎦
