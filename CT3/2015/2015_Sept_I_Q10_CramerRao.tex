...
% Page 10
\item (ii) Using asymptotic properties of the maximum likelihood estimator (MLE)
...
1 e
\item Therefore, likelihood is given as
  1 
K n K L e e

      
...

               
\item (b) If K = 0 the estimate of $\lambda$ is infinity, so we need K ≥ 1.
\item (iv) The estimator in part (i) is based on more information, as the exact values of
...
Parts (i) and (ii) mostly well answered. In part (iii) many candidates did not use the correct likelihood form. Answers to questions involving the likelihood function of a model that may not be typical, have also been problematic in
