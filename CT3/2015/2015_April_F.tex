...
A scatterplot of the data is given below:
  (ii) Comment on the relationship between crawling age and average temperature based on these observations. [2]
...
Based on these results:
  (iii) (a) Perform a statistical test to investigate the hypothesis that there is no linear relationship between crawling age and average temperature.
