...
%%Subject CT3 (Probability and Mathematical Statistics) – April 2015 – %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%Page 10
...
A scatterplot of the data is given below:
  \item (ii) Comment on the relationship between crawling age and average temperature based on these observations. 
