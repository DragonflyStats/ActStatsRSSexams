...
m x and μ x are equal when the force of mortality μ x+t is constant for 0 ≤ t < 1.
...
EITHER that the covariance of the process E [( X s − m ( s ))( X t − m ( t ))] depends only on the
time difference t – s .
...
Question 4
(i)
Right censoring: some areas never developed new weeds.
