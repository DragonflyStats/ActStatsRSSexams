...
(iii)
\begin{itemize}
\item The result of the Individual Standard Deviation test suggests outliers in the data.
...
\item However there are at least five (actual/expected) deaths in each age group, so the data are adequate.
So this is unlikely to account for the outlier at age 69 years, which should be investigated further.
\item The period of the observation is not stated and could affect the results, as, for example
...
data.
\item However there does seem to be a drift towards the number of observed deaths
...
\item Answers to this question were disappointing. Too many answers to part (i) were sketchy and
...
\item Although not all the points listed above were required in part (iii) for full credit, the number
