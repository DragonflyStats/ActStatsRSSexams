...
% There were a gratifying number of completely correct answers to this question, and many candidates scored full marks on parts (i)–(iii). Part (iv) was more demanding, and required candidates to invert the usual question and establish what transition matrix would give rise to a particular stationary distribution.
%%--------------------------- 20
\end{document}
