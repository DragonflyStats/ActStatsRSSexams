...
(ii)
The integrated hazard, \lambda x , is estimated as follows:
x j
n j
d j
c j
...
The survival function S ( x ) is given by exp( − \lambda x ), so that we have
(iii)
x S ( x )
0 ≤ x < 3
3 ≤ x < 4
...
Since S ( x ) = exp(−\lambda x ), the value of \lambda 6 corresponding to S (6) = 0.8 is
