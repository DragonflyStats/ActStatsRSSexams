...
method is \[h_{0 }( t ) exp( − 0.05 + 0.02) = h_{0 }( t ) exp( − 0.03).\]
Therefore the probability of him still playing after 4 years is
⎛ 4
⎞
S male (4) = exp ⎜ − \int h_{0 }( t ) exp( − 0.03) dt ⎟ = exp [ − 0.310078(0.970446) ]
⎝ 0
⎠
...
traditional method is $h_{0 }( t ) exp( \beta 2 )$ .
...
⎛
⎞
S female (4) = exp ⎜ − \int h_{0 }( t ) exp( \beta 2 ) dt ⎟ = exp ⎜ − exp( \beta 2 ) \int h_{0 }( t ) dt ⎟
0
⎝ 0
⎠
⎝
...
method giving up is 
\[h_{0 }( t ) exp( \beta 3 + \beta 4 ) .\]
Page 14%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5 — April 2008 — Examiners’ Report
Therefore the probability of him still playing after 4 years is
4
⎛
⎞
S male (4) = exp ⎜ − exp( \beta 3 + \beta 4 ) \int h_{0 }( t ) dt ⎟ .
0
⎝
⎠
4
