...
(i)
\begin{itemize}
    \item Consider the durations $t_j$ at which events take place.
\item Let the number of deaths at duration $t_j$ be d j and the number of insects still at
risk of death at duration $t_j$ be n j .
\item At t j = 1, $S(t)$ falls from 1.0000 to 0.9167.
\item Since the Kaplan-Meier estimate of S(t) is
S ( t )
(1
( t j )) ,
t j t
...
d 1 = 1 and n 1 = 12.
\begin{itemize}
    \item Similarly, at t j = 3, we must have 0.7130 0.9167(1
so that (3)
0.9167 0.7130
0.9167
0.222
...
.
n 3
\ite Since we can have at most 11 insects in the risk set at t j = 3, we must have
d 3 = 2 and n 3 = 9.
\item Similarly, at t j = 6, we must have 0.4278 0.7130(1 (6)) ,
so that (6)
0.7130 0.4278
0.7130
0.400
...
.
n 6
\item Since we can have at most 7 insects in the risk set at t j = 6, we must have
d 6 = 2 and n 6 = 5.
\item Therefore 2 insects died at duration 3 weeks and 2 insects died at duration 6
weeks.
\item Alternatively
...
7
\begin{itemize}
    \item Summing up the number of deaths we have
total deaths = d 1 d 3 d 6 1 2 2 5 .
\item Since we started with 12 insects, the remaining 7 insects histories were right-
censored.
\end{itemize}
