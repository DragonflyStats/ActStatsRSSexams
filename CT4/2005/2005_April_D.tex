...
(i)
\begin{itemize}
\item If the hazard for life i is ( t ; z i ) , then
l 0 ( t ) exp( b z i T ) ,
l ( t ; z i )
where
(ii)
...
\item The model is semi-parametric because is possible to estimate from the data without estimating the baseline hazard.
\item Therefore the baseline hazard can have any shape determined by the data.
B2
\item Since
t
t
