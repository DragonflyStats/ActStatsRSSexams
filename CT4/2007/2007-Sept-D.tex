...
Page 12Subject CT4 — Models Core Technical — September 2007 — Examiners’ Report
(iii)
The game either ends after 2 points or it returns to Deuce.
The probability of it returning to Deuce after two points is:
Prob A wins 1 st point × Prob B wins 2 nd point
+ Prob B wins 1 st point × Prob A wins 2 nd point
...
A Adv A = 0.6 × A Game A + 0.4 × A Deuce = 0.6 + 0.4 × A Deuce .
Similarly:
A Adv B = 0.6 × A Deuce ,
and
A Deuce = 0.6 × A Adv A + 0.4 × A Adv B = 0.6 × A Adv A + 0.24 × A Deuce .
Page 13Subject CT4 — Models Core Technical — September 2007 — Examiners’ Report
So,
A Deuce =
0.6
A Adv A ,
