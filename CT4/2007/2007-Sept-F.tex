...
evidence that the destination that the next jump depends on the previous state occupied. Need to test the other assumptions].
...
probabilities p ij * ( h ) = δ ij + h \sigma  ij .
