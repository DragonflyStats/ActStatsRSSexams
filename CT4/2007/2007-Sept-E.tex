...
(ii)
Type I censoring, since the investigation ends after a period which is fixed in
advance.
...
Then if the maximised log-likelihoods of the two models are L p and L p + q , then
the statistic
− 2( L p − L p + q )
