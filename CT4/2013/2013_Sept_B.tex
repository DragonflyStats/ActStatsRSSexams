...
%%--------------9]
A motor insurer offers a No Claims Discount scheme which operates as follows. The
discount levels are {0%, 25%, 50%, 60%}. Following a claim-free year a
...
60% discount is reached the driver remains at that level regardless of how many
