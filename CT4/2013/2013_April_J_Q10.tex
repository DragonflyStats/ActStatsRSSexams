...
In part (ii) minor variations on the exact derivation given above were permitted, but all the steps were required for full credit. In part (iii) some candidates attempted a solution using integral equations. A relatively common example argued that the required probability could
be obtained from:
3 3 3
0 0 0
12
