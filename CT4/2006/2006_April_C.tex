...
April 2006
Examiners Report
(a) A continuous-time Markov process X t ,t 0 with a discrete state
...
w
(b)
Given there is a transition from state H at time w, the probabilities that
...
( w )
( w )
This is the probability that the individual is in state H at time w,
