...
\begin{enumerate}
1
A bag contains 8 black and 6 white balls. Two balls are drawn out at random, one after the other and without replacement.
Calculate the probabilities that:
\begin{enumerate}[()]
\item The second ball drawn out is black.
\item The first ball drawn out was white, given that the second ball drawn out is black.
\end{enumerate}
