...
12
9
\item (iii) Derive the maximum likelihood estimator of the transition rate from Single to
Dead.
...
d 23
where
\mu ij is the transition intensity from state i to state j
...
log e ( L ) = −\mu 13 ν 1 + d 13 log e ( \mu 13 ) + terms not involving \mu 13 .
13
...
The maximum likelihood estimate of \mu 13 is 12/10,298 = 0.001165.
The variance is
− 1
d 2 ln( L )
( d \mu 13 ) 2
