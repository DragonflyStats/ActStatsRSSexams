...
% Many candidates struggled with this question. A common error in (ii) was to draw a matrix5 with five states rather than four, failing to recognise that taxis with four passengers in do not wait at the front of the queue, but depart as soon as the fourth passenger arrives. Most candidates who attempted (iv) wrote down a generator matrix, whereas the question asked for a transition matrix.
%%Page 16 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% — 
\end{document}
