...
(iv) EITHER
\begin{itemize}
\item The expected cost of the scheme per member per year is
\[(0 \times 0.5333) + (\$10 \times 0.2667) + (\$20 \times 0.1333) + (\$30 \times 0.0667) = \$7.33\]
\item For the scheme to be worth running, therefore, the average profit
per member per year must exceed \$7.33.
\item The profit per member is 0 for the 40% who book no flights,
...
\item For there to be a profit, we must have
\[(0.4 \times 0) + (0.4 \times \$10) + (0.2 \times \$10 m ) > 7.33\]
or
4 + 2 m > 7.33
2 m > 3.33
m > 1.67
\item This must be the case since m cannot be less than 2.
\item Therefore the airline makes a profit on the members of the scheme.
\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%
OR
