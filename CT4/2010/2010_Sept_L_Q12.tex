...
0.2
0
If stationary distribution is \pi_= ( \pi_{1} \pi_{2}
0
0.4
0.4
0.2
...
0.4
\pi_{4} )
Then \pi_A = \pi_where A is the matrix in (i)
0.4 \pi_{1} + 0.4 \pi_{2} + 0.2 \pi_{3} = \pi_{1}
0.4 \pi_{2} + 0.4 \pi_{3} + 0.2 \pi_{4} = \pi_{2}
0.4 \pi_{3} + 0.4 \pi_{4} = \pi_{3}
0.6 \pi_{1} + 0.2 \pi_{2} + 0.4 \pi_{4} = \pi_{4}
(a)
(b)
(c)
(d)
From (c) \pi_{3} = 0.666666 \pi_{4}
From (b) \pi_{2} = 0.7778 \pi_{4}
From (a) \pi_{1} = 0.7407 \pi_{4}
\pi_{1} + \pi_{2} + \pi_{3} + \pi_{4} = 1 = (0.7407 + 0.7778 + 0.6666 + 1) \pi_{4}
Implies \pi_{1} = 0.2325 , \pi_{2} = 0.2442 , \pi_{3} = 0.2093 , \pi_{4} = 0.31395
OR \pi_{1} =
(iii)
10
21
...
43
86
Probability of restocking is 0.6 if in \pi_{1} and 0.2 if in \pi_{2}
So long term rate = 0.6 * 0.2325 + 0.2 * 0.2442 = 0.1884 per trading day
(iv)
Probability of losing a sale is 0.2 if in \pi_{1}
