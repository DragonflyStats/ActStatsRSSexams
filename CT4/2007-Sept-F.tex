...
The critical value of χ 8 2 at the 5% significance level is 15.51
...
Page 18Subject CT4 — Models Core Technical — September 2007 — Examiners’ Report
(v)
[Refer back to part (i) — the test in (iv) has only tested that there is no
...
(vi)
APPROXIMATE METHOD
Divide time into very short intervals, h , such that σ ij h is much less than 1.
Simulate a discrete-time Markov chain { Y n : n ≥ 0 } , with transition
probabilities p ij * ( h ) = δ ij + h σ ij .
