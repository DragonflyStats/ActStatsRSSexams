...
0.5
0
this is incorrect because it implicitly assumes that the kiln is run for a complete cycle with a failed element. 

%%It was penalised in part (iv) but full credit could be scored in part (v) for the correctly followed-through stationary distribution.
