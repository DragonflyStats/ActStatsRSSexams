...
Random
[3]
(ii) State, with a reason, whether the censoring in this investigation is likely to be informative.

(iii) Calculate the value of the Kaplan-Meier estimate of the survival function at duration 28 days.
(iv) Write down the Kaplan-Meier estimate of the hazard of death at duration 8 days.
...
(i)
Explain why the status of an individual customer can be considered as a Markov Jump Process. [2]
(ii) ′ ( t ) .
Write down Kolmogorov’s forward equation for P OFF
(iii) Solve the equation in part (ii) to obtain a formula for the probability that a customer is offline at time t, given that they were offline at time 0.
