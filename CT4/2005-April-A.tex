...
(ii)
A2
For each of the processes in (i), classify it as a stochastic process according to
its state space and the time that it operates on.
[2]
[Total 4]
...
Let N t be a Poisson process, t 0 and let Y 1 , Y 2 , , Y j , , be a
...
j 1
(ii)
(a) A simple random walk operates on discrete time and has a discrete
...
variables Y j are discrete or continuous respectively.
A2
