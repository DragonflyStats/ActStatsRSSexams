...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Answers to this straightforward bookwork question were disappointing. Although most candidates could describe the difference between a % constant force of mortality and the increasing force implied by a uniform distribution of deaths, few made correct reference to the 
% form of the survival function. An alarming number of candidates referred to survival functions which increased with age! Credit was 
% given for graphs which correctly depicted the shape of the survival function under the two assumptions.
%%%%%%%%%%%%%%%%%%%%%
\newpage
2
