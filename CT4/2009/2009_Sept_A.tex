...
answered. Part \item (ii) required more thought, but many candidates were able to
...
through correctly in \item (iii) were awarded full marks for part \item (iii). Note also that
